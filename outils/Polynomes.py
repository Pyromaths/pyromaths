...
def choix_coeffs(unitaire, nbrac, entiers):
    """Génère un polynôme du second degré, unitaire ou non, suivant le nombre
    de racines demandé, et avec des coeffs entiers ou non.
    ...
    if nbrac == 1:
        ...
        coeffrac = [a*sgn[sgns[0]], random.randint(0, 200)*sgn[sgns[1]] /
                entier, random.randint(0, 200)*sgn[sgns[2]]]
    ...
    if nbrac == 0:
        ...
        coeffs = suppr0list([coeffrac[0],
            -coeffrac[0]*(coeffrac[1]+coeffrac[2]),
            coeffrac[0]*coeffrac[1]*coeffrac[2]])
