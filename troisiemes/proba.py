...
def proba(f0,f1):
    ...
    n4, d4 = n1*(n1-1+n2+n3),tot*(tot-1)
    result4=Fractions.TeX(Fractions(n4, d4)) #resultat non simplifié de la question 4
    if Fractions(n4, d4) != Fractions.simplifie(Fractions(n4, d4)):
        result4 += " = %s" % Fractions.TeX(Fractions.simplifie(Fractions(n4, d4)))
