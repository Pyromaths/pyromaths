...
p = Py2deb("pyromaths")
p.author = "Jérôme Ortais"
p.mail = "jerome.ortais@pyromaths.org"
p.description = """Générateur d'exercices
Pyromaths génère des exercices types de mathématiques de collège et lycée ainsi
que leur corrigé au format LaTeX."""
