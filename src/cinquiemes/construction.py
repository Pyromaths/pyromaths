...
##    cor.append(_(u"\\item enfin je vérifie les trois {\\color{enonce}conditions de l'énoncé}."))
    cor.append("\\end{enumerate}\n")
...
##    cor.append("\\begin{multicols}{2}")
    ...
    cor.append(_(u"\\item enfin, je reporte au compas la longueur \\mbox{$%s%s=\\unit[%s]{cm}$} à partir de $%s$.")%(A,C,decimaux(b),A))
    cor.append("\\end{enumerate}}")
##    cor.append("\\end{multicols}")
