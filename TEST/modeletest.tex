...
\usepackage{amssymb,multicol,calc,vmargin,cancel,fancyhdr,units,pst-eucl,wrapfig,lastpage,wasysym,pst-plot,pst-text,tabularx}
...
{\psset{linestyle=none}
\pstextpath[c](0,1.2ex){\psline{}(#1)(#2)}{#3}}
} 
