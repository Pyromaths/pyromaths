...
\hypersetup{pdfauthor={Jér\^ome Ortais},pdfsubject={Exercices de mathématiques},pdftitle={Exercices créés par Pyromaths, un programme en Python de Jér\^ome Ortais}}
\makeatletter
