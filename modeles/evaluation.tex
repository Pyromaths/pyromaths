...
\hypersetup{pdfauthor={Jérôme Ortais},pdfsubject={Exercices de
    mathématiques},pdftitle={Exercices créés par Pyromaths, un programme en
    Python de Jérôme Ortais}}
\makeatletter
...
{\noindent \textbf{NOM :} \hfill \textbf{Classe : ##{{NIVEAU}}##}}\par
