...
\hypersetup{pdfauthor={Jerome Ortais},pdfsubject={Exercices de mathematiques},pdftitle={Exercices crees par Pyromaths, un programme en Python de Jerome Ortais}}
\makeatletter
