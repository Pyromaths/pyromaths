...
\hypersetup{pdfauthor={J�r�me Ortais},pdfsubject={Exercices de math�matiques},pdftitle={Exercices cr��s par Pyromaths, un programme en Python de J�r\^ome Ortais}}
\makeatletter
...
\newcommand*\exercice{%
  ...
  \@ifstar%
  {\penalty-130\styleexo[Corrig� de l'exercice]}%
...
\pagestyle{fancy}
\cfoot{\textsl{\footnotesize{Ann�e \number\count1/\number\count2}}}
